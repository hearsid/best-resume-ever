...
<div class="resume">
  <div class="leftCol m_box">
    ...
    <a v-if="person.contact.stackoverflow" :href="contactLinks.stackoverflow" target="_blank">
      <div class="item">
        <div class="icon">
          <i class="fa fa-stackoverflow"></i>
        </div>
        <div class="text">
          <span>@{{person.contact.stackoverflow}}</span>
          <span>https://www.linkedin.com/in/{{person.contact.stackoverflow}}</span>
        </div>
      </div>
    </a>
...
const name = 'material-dark-extended';
